          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomInputField(
                    hintText: 'enter last name', inputController: _conLastName),
                Text(
                  'Your email',
                  style: Theme.of(context).textTheme.displaySmall,
                ),
                CustomInputField(
                    hintText: 'enter email', inputController: _conEmail),
                Text(
                  'Password',
                  style: Theme.of(context).textTheme.displaySmall,
                ),
                CustomInputField(
                    hintText: 'enter password', inputController: _conPassword),
                const SizedBox(height: 10),
                    ...
                    return MainButton(
                      ...
                      onPressed: () async {
                        await BlocProvider.of<AuthCubit>(context).register(
                          RegisterParams(
                            name: _conFirstName.text + _conLastName.text,
