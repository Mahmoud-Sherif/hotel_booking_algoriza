...
class BookingHotelsModel {
  ...
  factory BookingHotelsModel.fromJson(Map<String, dynamic> json) {
    return BookingHotelsModel(
...
class HotelsDataModel {
  final List<BookingDataModel> booking;
  ...
  factory HotelsDataModel.fromJson(Map<String, dynamic> json) {
    return HotelsDataModel(
      booking: List<BookingDataModel>.from(
